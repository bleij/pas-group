                    ...
                    .map((s) => (
                        <motion.div key={s.id} variants={fadeOnly}>
                            <SpotlightCard
                                ...
                                className="flex-none w-[320px] rounded-2xl bg-[#F3F4F6] p-5 flex flex-col justify-between transition-all cursor-pointer hover:bg-[#E5E7EB] active:bg-[#D1D5DB] h-[320px]"
                            >
                                {/* верхняя часть */}
                                <div className="flex flex-col flex-grow">
                                    <div>
                                        <div
                                            className="w-14 h-14 flex items-center justify-center rounded-xl bg-[#009999] mb-4">
                                ...
                                <div className="mt-auto pt-4">
                                    <button
                                        onClick={() => onOpenModal(s.title)}
                                        className="inline-block px-6 py-2.5 rounded-md font-medium text-sm
                   bg-[#E5E7EB] text-[#374151]
                   transition-all duration-500 ease-in-out
                   hover:bg-[#009999] hover:text-white hover:shadow-md"
                                    >
                                        Заказать услугу
                                    </button>
                                </div>
