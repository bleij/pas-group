...
export default function Advantages() {
    ...
    return (
        <motion.section
            ...
            variants={blurUp}
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
                {/* Текстовая часть */}
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <div className="relative rounded-[16px] md:rounded-[24px] overflow-hidden w-full sm:w-[400px] md:w-[500px] h-48 sm:h-64 md:h-[520px] shadow-lg">
                        <Image
                            src="/advantages.png"
