    ...
    return (
        <header
            ...
            className={`fixed inset-x-0 top-0 z-50 transition-colors duration-300 ${
                scrolled ? "bg-white text-black border-b border-gray-200" : "bg-transparent text-white"
            }`}
        >
            {/* верхняя контактная полоса (только десктоп) */}
           ...
           whitespace-nowrap overflow-hidden text-ellipsis"
            ...
            {open && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex justify-end">
                    <div className="h-full w-[82%] max-w-[360px] bg-slate-900 text-white p-6 shadow-xl flex flex-col">
